package com.solution.onequestionperday.march2021.designparkingsystem1603;

/**
 * 1603. Design Parking System Design a parking system for a parking lot. The
 * parking lot has three kinds of parking spaces: big, medium, and small, with a
 ...
 * part of the constructor. bool addCar(int carType) Checks whether there is a
 * parking space of carType for the car that wants to get into the parking lot.
 * carType can be of three kinds: big, medium, or small, which are represented
 * by 1, 2, and 3 respectively. A car can only park in a parking space of its
 ...
 * [1], [2], [3], [1]] Output [null, true, true, false, false]
 * 
 ...
 * Constraints:
 * 
 * 0 <= big, medium, small <= 1000 carType is 1, 2, or 3 At most 1000 calls will
 * be made to addCar
 * 
 * 
 ...
 * small) 初始化 ParkingSystem 类，三个参数分别对应每种停车位的数目。 bool addCar(int
 ...
 * 示例 1：
 * 
 * 输入： ["ParkingSystem", "addCar", "addCar", "addCar", "addCar"] [[1, 1, 0],
 * [1], [2], [3], [1]] 输出： [null, true, true, false, false]
 * 
 * 解释： ParkingSystem parkingSystem = new ParkingSystem(1, 1, 0);
 * parkingSystem.addCar(1); // 返回 true ，因为有 1 个空的大车位 parkingSystem.addCar(2); //
 * 返回 true ，因为有 1 个空的中车位 parkingSystem.addCar(3); // 返回 false ，因为没有空的小车位
 ...
 * 
 * 来源：力扣（LeetCode） 链接：https://leetcode-cn.com/problems/design-parking-system
